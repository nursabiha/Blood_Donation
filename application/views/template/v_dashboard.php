<!-- /**********************************************************************************************************************
*FIle Name                       : v_dashboard.php
*Description                     : view : view dashboard
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="<?php echo site_url('template/v_dashboard');?>">Dashboard</a></li>
            <!-- <li><a href="template/v_dashboard.php">Dashboard</a></li> -->
            <li><a href="v_profile.php">Profile</a></li>
            <li><a href="v_donation.php">Donation</a></li>
            <li><a href="v_info.php">Info</a></li>
          </ul>
