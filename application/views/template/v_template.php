...
<!--  <div class="container">      
  <img src="/assets/image/logo/logo.jpg" class="img-rounded" alt="Cinque Terre" width="204" height="136"> 
</div>  -->
        </div>
 </div> 
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo site_url('c_page/view_homepage');?>">
            ...
            <li>
                ...
                <span class="glyphicon glyphicon-tint"></span> Donation<span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
              <li><a href="../c_admin/add_donation">Add Blood Donation Detail</a></li>
              <li><a href="../c_admin/check_donation">Detail Blood Donation</a></li>
              <li class="divider"></li>
              <li><a href="#">Separated link</a></li>
              </ul>
            </li>
